...
Over the air firmware updates may be uploaded by exporting a binary from the Arduino IDE, connecting to the pilot's SSID, and going to 192.168.4.1/update to upload the binary.
