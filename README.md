...
This is a simple, inexpensive (~$150 total project cost including motor linkage), compass-only marine autopilot for wheel or tiller that functions like a Raymarine ST2000 or a CPT. As of January 2026, the code is updated to ESP32 Arduino Core 3 from 2.1.2. You will need to make three simple changes to libraries (described below) for the code to compile and work properly.
