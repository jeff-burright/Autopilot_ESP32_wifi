...
// Adafruit_SSD1306 display(SCREEN_WIDTH, SCREEN_HEIGHT, &Wire, -1);
    ...
    // float counts_max = 4095;  // from calibration in print statement
...
//float Kxte[3] = {.2, 0, 0}; // {.2, 4, .0004} baseline; {.05, .5, .0005}last used;  0 is proportional, 1 is differential, 2 is integral error, see GPS_Steer() in PID
 ...
 float Magnetic_Variation = 14; //corrected for installation on my boat
...
float LPFRuddPin = 0.0;  // low pass filter
int rawRuddPin = 0; // low pass filter
