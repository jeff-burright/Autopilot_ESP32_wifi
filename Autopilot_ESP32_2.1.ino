...
#define IMU 2 //  1 for home prototype, 2 for IMU on wheel pilot, 3 for IMU on tiller pilot (Jeff's)    //determines which set of calibration data is used 
...
#define RUDDER_SENSOR 1 // 0 uses potentiometer; 1 uses hall sensor for rudder position indicator. The difference is the calibration of the sensor in the PID tab.
...
// NOTE: search for "motorspeedMIN" to set minimum power to motor. Currently set at 75 for faster response. 
