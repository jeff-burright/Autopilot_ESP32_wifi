...
-- fixed wifi not broadcasting AP by disabling LR mode and the PSmode variable. 
-- additional fixes to compass tilt compensation. Current version works when the chip is face down. 
